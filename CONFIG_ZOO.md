...
- Hidden agent folders: `.agents/`, `.agent/`, `.cursor/`, `.claude/`, `.gemini/`, `.windsurf/`, `.continue/`, `.aider/`, `.goose/`, `.openhands/`, `.codex/`, `.amazonq/`, `.codeium/`, `.sourcegraph/`, `.qodo/`, `.cody/`, `.junie/`, `.kiro/`, `.augment/`, `.roo/`, `.amp/`, `.superclaude/`
